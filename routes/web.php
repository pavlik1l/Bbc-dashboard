...
Route::get('/', [BbcController::class, 'index'])->name('index');
...
Route::get('/home/{bb}/delete', [HomeController::class, 'showDeleteForm'])
...
Route::get('/{bb}', [BbcController::class, 'detail'])->name('detail');
